...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (docker yasnippet-snippets yapfify ws-butler winum which-key wgrep uuidgen use-package unfill toc-org tablist string-inflection sql-indent spaceline-all-the-icons solarized-theme smex restart-emacs ranger rainbow-mode rainbow-identifiers pyvenv pytest pyenv-mode py-isort protobuf-mode popwin pippel pip-requirements persp-mode pcre2el password-generator paradox overseer org-pomodoro org-mime org-brain open-junk-file neotree nameless mwim move-text monokai-theme mmm-mode markdown-toc macrostep live-py-mode linum-relative link-hint json-mode ivy-rtags ivy-hydra indent-guide importmagic ibuffer-projectile hy-mode hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers google-c-style golden-ratio godoctor go-tag go-rename go-guru go-eldoc gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link ggtags fuzzy font-lock+ flycheck-ycmd flycheck-rtags flycheck-pos-tip flycheck-gometalinter flx fill-column-indicator expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-tutor evil-surround evil-search-highlight-persist evil-org evil-numbers evil-nerd-commenter evil-matchit evil-magit evil-lion evil-iedit-state evil-cleverparens evil-anzu eval-sexp-fu elisp-slime-nav editorconfig dumb-jump dockerfile-mode docker-tramp diminish cython-mode counsel-gtags company-ycmd company-statistics company-rtags company-go company-c-headers company-anaconda column-enforce-mode color-identifiers-mode bind-map auto-yasnippet auto-highlight-symbol auto-compile aggressive-indent adaptive-wrap ace-window ace-link)))
 '(pos-tip-background-color "#A6E22E")
 '(pos-tip-foreground-color "#272822")
 '(vc-annotate-background nil)
 '(vc-annotate-color-map

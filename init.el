...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (which-key use-package string-inflection spaceline solarized-theme pyvenv pip-requirements org-pomodoro alert yapfify xterm-color ws-butler winum wgrep volatile-highlights vi-tilde-fringe uuidgen unfill toc-org symon stickyfunc-enhance srefactor sql-indent smex smeargle shell-pop restart-emacs realgud ranger rainbow-mode rainbow-identifiers rainbow-delimiters pytest pyenv-mode py-isort protobuf-mode powerline popwin plantuml-mode persp-mode pcre2el password-generator paradox overseer orgit org-projectile org-present org-download org-bullets org-brain open-junk-file neotree nameless mwim multi-term move-text monokai-theme mmm-mode markdown-toc magit-gitflow macrostep lorem-ipsum log4e live-py-mode linum-relative link-hint ivy-purpose ivy-hydra info+ indent-guide ibuffer-projectile hy-mode hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers highlight-indentation hide-comnt help-fns+ helm-make graphviz-dot-mode google-translate google-c-style golden-ratio godoctor go-tag go-rename go-guru go-eldoc gnuplot gntp gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link ghub gh-md ggtags fuzzy flycheck-ycmd flycheck-pos-tip flycheck-gometalinter flx-ido fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-org evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help elisp-slime-nav editorconfig dumb-jump dockerfile-mode docker disaster diminish define-word cython-mode counsel-projectile counsel-gtags company-ycmd company-statistics company-go company-c-headers company-anaconda column-enforce-mode color-identifiers-mode cmake-mode cmake-ide clean-aindent-mode clang-format bind-key auto-yasnippet auto-highlight-symbol auto-compile aggressive-indent adaptive-wrap ace-window ace-link ac-ispell)))
 '(pos-tip-background-color "#A6E22E")
 '(pos-tip-foreground-color "#272822")
 '(vc-annotate-background nil)
 '(vc-annotate-color-map
